...
public:
  ...
  void add_field(const std::string &identifier, const SNode *rep_snode,
                 bool is_scalar, DataType dt, std::vector<int> shape,
                 int row_num, int column_num);

  void add_kernel_template(const std::string &identifier,
                           const std::string &key, Kernel *kernel);
...
protected:
  ...
  virtual void add_field_per_backend(const std::string &identifier,
                                     ...
                                     DataType dt, std::vector<int> shape,
                                     int row_num, int column_num) {
    TI_NOT_IMPLEMENTED;
  }
  ...
  virtual void add_ndarray_per_backend(const std::string &identifier,
                                       ...
                                       std::vector<int> shape, int row_num,
                                       int column_num) {
    TI_NOT_IMPLEMENTED;
  }
