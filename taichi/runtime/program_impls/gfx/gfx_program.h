...
public:
  ...
  StreamSemaphore flush() override { return runtime_->flush(); }
  ...
  Device *get_compute_device() override { return device_.get(); }

  Device *get_graphics_device() override { return device_.get(); }
