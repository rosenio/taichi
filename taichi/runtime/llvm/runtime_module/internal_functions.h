...
i32 do_nothing(RuntimeContext *context) { return 0; }

i32 refresh_counter(RuntimeContext *context) { return 0; }

i32 insert_triplet_f32(RuntimeContext *context, int64 base_ptr_, int i, int j,
                       float value) {
  ATOMIC_INSERT(32);
  return 0;
}

i32 insert_triplet_f64(RuntimeContext *context, int64 base_ptr_, int i, int j,
                       float64 value) {
  ATOMIC_INSERT(64);
  return 0;
}

i32 test_internal_func_args(RuntimeContext *context, float32 i, float32 j,
                            int32 k) {
