...
public:
  ...
  template <typename T> void set_arg(const std::vector<int> &i, T v);
  ...
  template <typename T> void set_struct_arg(std::vector<int> arg_indices, T v);

  void set_ndarray_ptrs(const std::vector<int> &arg_id, uint64 data_ptr,
                        uint64 grad_ptr);
  void set_argpack_ptr(const std::vector<int> &arg_id, uint64 data_ptr);

  template <typename T> T get_arg(const std::vector<int> &i);

  template <typename T> T get_struct_arg(std::vector<int> arg_indices);

  template <typename T> T get_ret(int i);

  void set_arg_external_array_with_shape(const std::vector<int> &arg_id,
                                         uintptr_t ptr, uint64 size,
  ...
  void set_arg_ndarray_with_grad(const std::vector<int> &arg_id,
                                 const Ndarray &arr, const Ndarray &arr_grad);
