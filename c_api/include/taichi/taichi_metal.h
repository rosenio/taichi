...
TI_DLL_EXPORT void TI_API_CALL ti_export_metal_runtime(
    TiRuntime runtime, TiMetalRuntimeInteropInfo *interop_info);

// Function `ti_import_metal_memory`
TI_DLL_EXPORT TiMemory TI_API_CALL ti_import_metal_memory(
    TiRuntime runtime, const TiMetalMemoryInteropInfo *interop_info);

// Function `ti_export_metal_memory`
TI_DLL_EXPORT void TI_API_CALL ti_export_metal_memory(
    TiRuntime runtime, TiMemory memory, TiMetalMemoryInteropInfo *interop_info);

// Function `ti_import_metal_image`
TI_DLL_EXPORT TiImage TI_API_CALL ti_import_metal_image(
    TiRuntime runtime, const TiMetalImageInteropInfo *interop_info);
