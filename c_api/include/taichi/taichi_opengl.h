...
TI_DLL_EXPORT TiRuntime TI_API_CALL ti_import_opengl_runtime(
    TiOpenglRuntimeInteropInfo *interop_info, bool use_gles);

// Function `ti_export_opengl_runtime`
TI_DLL_EXPORT void TI_API_CALL ti_export_opengl_runtime(
    TiRuntime runtime, TiOpenglRuntimeInteropInfo *interop_info);

// Function `ti_import_opengl_memory`
TI_DLL_EXPORT TiMemory TI_API_CALL ti_import_opengl_memory(
    TiRuntime runtime, const TiOpenglMemoryInteropInfo *interop_info);

// Function `ti_export_opengl_memory`
TI_DLL_EXPORT void TI_API_CALL
ti_export_opengl_memory(TiRuntime runtime, TiMemory memory,
                        TiOpenglMemoryInteropInfo *interop_info);

// Function `ti_import_opengl_image`
TI_DLL_EXPORT TiImage TI_API_CALL ti_import_opengl_image(
    TiRuntime runtime, const TiOpenglImageInteropInfo *interop_info);

// Function `ti_export_opengl_image`
TI_DLL_EXPORT void TI_API_CALL ti_export_opengl_image(
    TiRuntime runtime, TiImage image, TiOpenglImageInteropInfo *interop_info);
